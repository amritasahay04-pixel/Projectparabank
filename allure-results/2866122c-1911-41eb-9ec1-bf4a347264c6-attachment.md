...
Locator: getByText('Welcome Testers')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Welcome Testers')
...
> 107 |     await expect(page.getByText('Welcome ' + testdataForregistration.firstname)).toBeVisible()
      |                                                                                  ^ Error: expect(locator).toBeVisible() failed
