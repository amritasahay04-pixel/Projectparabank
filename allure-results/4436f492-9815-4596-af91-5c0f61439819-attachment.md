...
> 109 |     await expect(page.locator('form')).toBeVisible()
  ...
  147 |     await expect(page.getByText('Transfer Funds')).toBeVisible()
  ...
  153 |     )
  154 |     await fundtransferpage.transferButtonClick()
  155 |     await page.waitForTimeout(3000)
  156 |     await expect(page).toHaveURL('https://parabank.parasoft.com/parabank/transfer.htm')
  157 |     await expect(page.getByText('Transfer Complete!')).toBeVisible()
  158 |     
  159 | 
  160 | 
  161 | }
