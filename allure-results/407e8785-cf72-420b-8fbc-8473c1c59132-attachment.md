...
> 109 |     await expect(page.getByRole('button', { name: 'Register' })).toBeVisible()
      |                                                                  ^ Error: expect(locator).toBeVisible() failed
  110 |     await expect(page.locator('input[id="customer.username"]')).toBeVisible()
  111 |       
  112 | })
  113 | 
  114 | 
