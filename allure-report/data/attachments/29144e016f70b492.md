...
```
ReferenceError: awaitexpect is not defined
```
...
> 110 |     awaitexpect(page).toHaveURL('https://parabank.parasoft.com/parabank/register.htm')
      |     ^ ReferenceError: awaitexpect is not defined
