...
Received string:    "parabank.parasoft.com"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('h1')
    14 × locator resolved to <h1>parabank.parasoft.com</h1>
       - unexpected value "parabank.parasoft.com"
...
> 109 |     await expect(page.locator('h1')).toContainText('Signing up is easy!')
      |                                      ^ Error: expect(locator).toContainText(expected) failed
  110 |     await expect(page.getByRole('button', { name: 'Register' })).toBeVisible()
  111 |       
  112 | })
  113 | 
  114 | 
